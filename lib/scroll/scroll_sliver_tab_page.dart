...
final Map<_Page, List<_CardData>> allPages = <_Page, List<_CardData>>{
...
class SliverTabPage extends StatelessWidget {
      ...
      child: new Scaffold(
        body: new NestedScrollView(
          headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
            return <Widget>[
              _buildSliverOverlapAbsorber(context, innerBoxIsScrolled),
            ];
          },
          body: new TabBarView(
            children: allPages.keys.map((_Page page) {
              return new SafeArea(
                top: false,
                bottom: false,
                child: new Builder(
                          ...
                          sliver: new SliverFixedExtentList(
                            ...
                            delegate: new SliverChildBuilderDelegate(
                              (BuildContext context, int index) {
                                final _CardData data = allPages[page][index];
                                return new Padding(
                                  padding: const EdgeInsets.symmetric(
                                    vertical: 8.0,
                                  ),
